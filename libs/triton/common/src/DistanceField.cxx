...
namespace sdf {
   ...
   auto DistanceField::getNoiseValue(float xCoord, float yCoord, float zCoord) -> float {
      auto value = perlinNoise->GetNoise(xCoord / factor, yCoord / factor, zCoord / factor);
      return static_cast<float>(value);
   }

   auto DistanceField::getValue(float xCoord, float yCoord, float zCoord) -> float {
   ...
   auto DistanceField::computeGradient(float xCoord, float yCoord, float zCoord)
