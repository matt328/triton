...
void imdd_reserve(imdd_shape_store_t* store,
...
static inline void IMDD_VECTORCALL imdd_line(imdd_shape_store_t* store,
                                             imdd_zmode_enum_t zmode,
                                             imdd_v4 start,
                                             imdd_v4 end,
                                             uint32_t color) {
...
static inline void IMDD_VECTORCALL imdd_triangle(imdd_shape_store_t* store,
                                                 imdd_style_enum_t style,
                                                 imdd_zmode_enum_t zmode,
                                                 imdd_v4 pos_a,
                                                 imdd_v4 pos_b,
...
static inline void IMDD_VECTORCALL imdd_shape(imdd_shape_store_t* store,
                                              imdd_shape_enum_t shape,
                                              imdd_style_enum_t style,
                                              imdd_zmode_enum_t zmode,
                                              imdd_v4 x_axis_vec,
...
static inline void IMDD_VECTORCALL imdd_aabb(imdd_shape_store_t* store,
                                             imdd_style_enum_t style,
                                             imdd_zmode_enum_t zmode,
                                             imdd_v4 min,
                                             imdd_v4 max,
...
static inline void IMDD_VECTORCALL imdd_obb(imdd_shape_store_t* store,
                                            imdd_style_enum_t style,
                                            imdd_zmode_enum_t zmode,
                                            imdd_v4 x_axis_vec,
                                            imdd_v4 y_axis_vec,
...
static inline void IMDD_VECTORCALL imdd_sphere(imdd_shape_store_t* store,
                                               imdd_style_enum_t style,
                                               imdd_zmode_enum_t zmode,
...
static inline void IMDD_VECTORCALL imdd_ellipsoid(imdd_shape_store_t* store,
                                                  imdd_style_enum_t style,
                                                  imdd_zmode_enum_t zmode,
                                                  imdd_v4 x_axis_vec,
                                                  imdd_v4 y_axis_vec,
...
static inline void IMDD_VECTORCALL imdd_cone(imdd_shape_store_t* store,
                                             imdd_style_enum_t style,
                                             imdd_zmode_enum_t zmode,
                                             imdd_v4 x_axis_vec,
                                             imdd_v4 y_axis_vec,
...
static inline void IMDD_VECTORCALL imdd_cylinder(imdd_shape_store_t* store,
                                                 imdd_style_enum_t style,
                                                 imdd_zmode_enum_t zmode,
                                                 imdd_v4 x_axis_vec,
                                                 imdd_v4 y_axis_vec,
...
static inline void IMDD_VECTORCALL imdd_frustum(imdd_shape_store_t* store,
                                                imdd_style_enum_t style,
                                                imdd_zmode_enum_t zmode,
                                                imdd_v4 x_axis_vec,
                                                imdd_v4 y_axis_vec,
...
imdd_shape_store_t* imdd_init(void* mem, uint32_t size) {
   ...
   uint32_t const header_capacity =
       (uint32_t)((mem_end - mem_start) / 8) / sizeof(imdd_shape_header_t);
