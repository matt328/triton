...
//         .RETURN(vbh);
//     REQUIRE_CALL(*mockBufferManager, createGpuIndexBuffer(120960,
//     "Buffer-name-Index")).RETURN(ibh); REQUIRE_CALL(*mockBufferManager, addToBuffer(_, vbh, 0,
//     ibh, 0)).IN_SEQUENCE(seq); REQUIRE_CALL(*mockBufferManager, addToBuffer(_, vbh, 1000, ibh,
//     200)).IN_SEQUENCE(seq); REQUIRE_CALL(*mockBufferManager, addToBuffer(_, vbh, 2000, ibh,
//     400)).IN_SEQUENCE(seq);
...
//     REQUIRE_CALL(*mockBufferManager, createGpuIndexBuffer(120960,
//     "Buffer-name-Index")).RETURN(ibh); REQUIRE_CALL(*mockBufferManager, addToBuffer(_, vbh, 0,
//     ibh, 0)).IN_SEQUENCE(seq); REQUIRE_CALL(*mockBufferManager, addToBuffer(_, vbh, 2000, ibh,
//     1200)).IN_SEQUENCE(seq);
