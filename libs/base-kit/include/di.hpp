...
struct is_unique_impl<T1, T2, Ts...> : conditional_t<is_base_of<type<T2>, T1>::value,
                                                     not_unique<T2>,
...
#else
struct is_empty_expr<TExpr, valid_t<decltype(+declval<TExpr>()), decltype(declval<TExpr>()())>>
    : true_type {
};
#endif
template <class>
...
struct get_is_unique_error<aux::type_list<TDeps...>>
    : get_is_unique_error_impl<
          typename aux::is_unique<typename unique_dependency<TDeps>::type...>::type> {};
template <class... TDeps>
using boundable_bindings =
    aux::conditional_t<is_supported<TDeps...>::value,
...
struct is_related<true, I, T> {
  static constexpr auto value = aux::is_base_of<I, T>::value || (aux::is_convertible<T, I>::value &&
...
auto boundable_impl(I&&, T&&, aux::valid<>&&) -> aux::conditional_t<
    ...
    typename type_<T>::template is_not_related_to<I>>;
template <class I, class T>
auto boundable_impl(I*[], T&&) -> aux::conditional_t<aux::is_same<I, aux::decay_t<I>>::value,
                                                     boundable_impl__<I, T>,
...
auto boundable_impl(concepts::any_of<Ts...>&&, T&&) ->
    typename get_any_of_error<decltype(boundable_impl(aux::declval<Ts>(),
                                                      aux::declval<T>()))...>::type;
template <class... TDeps>
...
struct provider__ {
  ...
  aux::conditional_t<aux::is_same<TMemory, type_traits::stack>::value, T, T*> try_get(
      const TMemory& = {}) const;
  template <class TMemory = type_traits::heap>
...
struct pool<aux::type_list<TArgs...>> : TArgs... {
  ...
  pool& operator=(T&& other) noexcept {
    (void)aux::swallow{0,
                       (static_cast<TArgs&>(*this).operator=(static_cast<TArgs&&>(other)), 0)...};
    return *this;
  }
};
}
...
template <template <class...> class TIsConstructible, class T>
struct ctor_impl<TIsConstructible,
                 T,
...
struct ctor_impl<TIsConstructible,
    ...
    : aux::conditional<TIsConstructible<T, get<core::any_type_ref_fwd<T>, Ns>...>::value,
                       ...
                       typename ctor_impl<TIsConstructible,
                                          T,
...
struct array<T(), Ts...> : T {
  ...
  template <__BOOST_DI_REQUIRES(aux::is_constructible<T,
...
struct ctor_traits__<core::array<_, Ts...>, T, _1, aux::false_type>
    : type_traits::ctor_traits__<
          core::array<aux::remove_smart_ptr_t<aux::remove_qualifiers_t<T>>(), Ts...>> {};
}
namespace scopes {
class deduce {
public:
  ...
  public:
    ...
    using is_referable = typename TConfig::template scope_traits<
        T>::type::template scope<TExpected, TGiven>::template is_referable<T, TConfig>;
...
using ctor_size_t = ctor_size<
    typename type_traits::ctor<T, type_traits::ctor_impl_t<aux::is_constructible, T>>::type>;
...
struct creatable_error_impl
    : aux::conditional_t<
          ...
          aux::conditional_t<
              ...
              typename type<T>::has_to_many_constructor_parameters::template max<
...
struct is_expr : aux::integral_constant<
                     bool,
                     aux::is_invocable<TGiven, typename TProvider::injector, Ts...>::value &&
...
public:
  ...
  struct scope<TExpected, std::shared_ptr<TGiven>> {
    template <class T, class>
    using is_referable =
        typename wrappers::shared<instance,
                                  TGiven>::template is_referable<aux::remove_qualifiers_t<T>>;
  ...
  struct scope<TExpected, TGiven, __BOOST_DI_REQUIRES(aux::is_callable<TGiven>::value)> {
    template <class...>
    using is_referable = aux::integral_constant<bool,
    ...
    template <class T,
              ...
              __BOOST_DI_REQUIRES(!detail::is_expr<TGiven, TProvider>::value &&
                                  ...
                                  !aux::is_callable<TExpected>::value) = 0>
    static auto try_create(const TProvider&) noexcept -> detail::wrapper_traits_t<
        decltype(aux::declval<typename aux::identity<TGiven, T>::type>()())>;
    template <class,
              class,
              class TProvider,
              __BOOST_DI_REQUIRES(detail::is_expr<TGiven, TProvider>::value) = 0>
    static detail::wrapper_traits_t<
        decltype(aux::declval<TGiven>()(aux::declval<typename TProvider::injector>()))>
    ...
    template <
        ...
        class TProvider,
        __BOOST_DI_REQUIRES(
            detail::is_expr<TGiven, TProvider, const detail::arg<T, TExpected, TGiven>&>::value) =
            0>
    static detail::wrapper_traits_t<
        decltype(aux::declval<TGiven>()(aux::declval<typename TProvider::injector>(),
    ...
    class injector_impl : injector__<Ts>... {
      ...
      struct create<named<TName, T>, aux::true_type> {
        static T impl(const injector__<named<TName, T>>* object) {
          using type = aux::type<
              aux::conditional_t<aux::is_same<TName, no_name>::value, T, named<TName, T>>>;
  ...
  public:
    ...
    using is_referable = aux::true_type;
    template <class TInjector,
              __BOOST_DI_REQUIRES(aux::is_a<core::injector_base, TInjector>::value) = 0>
    ...
    template <class T, class TName, class TProvider>
    static aux::
        conditional_t<aux::is_base_of<injector__<named<TName, T>>, injector>::value, T, void>
        try_create(const TProvider&);
    template <class T, class TName, class TProvider>
    auto create(const TProvider&) {
      return wrapper<T>{
          injector_->create(named<TName, T>{},
...
class dependency
  ...
  using externable =
      aux::integral_constant<bool,
                             aux::always<T>::value && aux::is_same<TScope, scopes::deduce>::value &&
...
public:
  ...
  auto to(std::initializer_list<T> il) noexcept {
    using type = aux::remove_pointer_t<aux::remove_extent_t<TExpected>>;
    using dependency = dependency<scopes::instance,
                                  array<type>,
...
#endif
  template <class... Ts,
            __BOOST_DI_REQUIRES(sizeof...(Ts) && !aux::is_array<TExpected, Ts...>::value) = 0>
...
struct is_callable_impl<T, Ts...> {
  ...
  using type =
      aux::conditional_t<callable_with_arg::value,
...
struct bind :
#endif
    detail::bind<__BOOST_DI_REQUIRES_MSG(concepts::boundable<concepts::any_of<Ts...>>),
                 scopes::deduce,
                 Ts...>::type
#if defined(__cpp_variable_templates)
        bind
...
auto configurable_impl(T&&)
    -> aux::is_valid_expr<decltype(aux::declval<T>().provider(aux::declval<injector<T>*>())),
...
auto is_configurable(const aux::true_type&) {
  return typename get_configurable_error<
      decltype(providable<decltype(aux::declval<T>().provider(aux::declval<injector<T>*>()))>()),
      decltype(callable<decltype(aux::declval<T>().policies(aux::declval<injector<T>*>()))>())>::
      type{};
}
template <class T>
...
struct binder {
  ...
  struct resolve_template_impl<TDeps, aux::identity<T<Ts...>>> {
    using type = T<typename resolve_template_impl<
        TDeps,
        aux::remove_qualifiers_t<
            typename resolve__<TDeps, Ts, no_name, dependency<scopes::deduce, aux::decay_t<Ts>>>::
                type::given>>::type...>;
  };
  template <class T,
            class TName = no_name,
  ...
  static decltype(auto) resolve(TDeps* deps) noexcept {
    ...
    return resolve_(
        deps,
        aux::type<decltype(resolve_impl<TDefault, dependency>(aux::declval<TDeps*>()))>{});
#else
...
struct is_referable__ {
  static constexpr auto value = dependency__<
      binder::resolve_t<TInjector, T>>::template is_referable<T, typename TInjector::config>::value;
};
...
class policy {
  ...
  struct try_call_impl
      : aux::conditional_t<aux::is_base_of<_, aux::remove_reference_t<typename TArg::type>>::value,
                           aux::true_type,
...
struct provider<aux::pair<T, aux::pair<TInitialization, TList<TCtor...>>>, TName, TInjector> {
  ...
  struct is_creatable {
    using type =
        decltype(aux::declval<injector__<TInjector>>().cfg().provider(aux::declval<TInjector*>()));
    static constexpr auto value = type::template is_creatable<TInitialization, T, TArgs...>::value;
  };
  template <class TMemory = type_traits::heap>
  auto get(const TMemory& memory = {}) const {
    return get_impl(memory,
                    ((const injector__<TInjector>*)injector_)->create_impl(aux::type<TCtor>{})...);
  }
...
#if (BOOST_DI_CFG_DIAGNOSTICS_LEVEL >= 2)
    (void)aux::
        conditional_t<injector__<TInjector>::template is_creatable<T>::value, _, creating<T>>{};
#endif
    return cfg().provider(injector_).template get<T>(TInitialization{},
                                                     memory,
...
struct referable<const T&, TConfig, TDependency> {
  using type =
      aux::conditional_t<TDependency::template is_referable<const T&, TConfig>::value, const T&, T>;
};
#if defined(__MSVC__)
template <class T, class TConfig, class TDependency>
struct referable<T&&, TConfig, TDependency> {
  ...
  struct is_creatable {
    ...
    static constexpr auto value = aux::is_convertible<
        decltype(dependency__<dependency_t>::template try_create<T, TName>(
            try_provider<ctor_t,
                         injector,
                         decltype(aux::declval<TConfig>().provider(aux::declval<injector*>()))>{})),
        T>::value;
  };
  auto& cfg() {
    return config_;
...
struct is_injected : detail::type_op {
  template <class TArg,
            class U =
                aux::decay_t<aux::conditional_t<aux::is_same<T, _>::value, typename TArg::type, T>>>
  struct apply : aux::conditional_t<aux::is_class<U>::value,
...
struct constructible_impl {
  template <class TArg,
            __BOOST_DI_REQUIRES(TArg::is_root::value || T::template apply<TArg>::value) = 0>
...
template <bool IncludeRoot = false,
          class T = aux::never<_>,
...
#define __BOOST_DI_REPEAT_10(m, ...)                                                               \
  m(0, __VA_ARGS__) m(1, __VA_ARGS__) m(2, __VA_ARGS__) m(3, __VA_ARGS__) m(4, __VA_ARGS__)        \
      m(5, __VA_ARGS__) m(6, __VA_ARGS__) m(7, __VA_ARGS__) m(8, __VA_ARGS__) m(9, __VA_ARGS__)
#if defined(__MSVC__)
...
#define __BOOST_DI_IBP(...)                                                                        \
  __BOOST_DI_IBP_SPLIT(                                                                            \
      0,                                                                                           \
      __BOOST_DI_IBP_CAT(__BOOST_DI_IBP_IS_VARIADIC_R_, __BOOST_DI_IBP_IS_VARIADIC_C __VA_ARGS__))
...
#define __BOOST_DI_IBP(...)                                                                        \
  __BOOST_DI_IBP_SPLIT(                                                                            \
      0,                                                                                           \
      __BOOST_DI_CAT(__BOOST_DI_IBP_IS_VARIADIC_R_, __BOOST_DI_IBP_IS_VARIADIC_C __VA_ARGS__))
...
#define __BOOST_DI_HAS_NAMES(...)                                                                  \
  __BOOST_DI_IF(                                                                                   \
      __BOOST_DI_IS_EMPTY(                                                                         \
          __BOOST_DI_REPEAT(__BOOST_DI_SIZE(__VA_ARGS__), __BOOST_DI_HAS_NAME, __VA_ARGS__)),      \
      0,                                                                                           \
      1)
...
#define __BOOST_DI_INJECT_TRAITS_IMPL_0(...)                                                       \
  static void ctor(                                                                                \
      __BOOST_DI_REPEAT(__BOOST_DI_SIZE(__VA_ARGS__), __BOOST_DI_GEN_CTOR, __VA_ARGS__));          \
...
#define __BOOST_DI_INJECT_TRAITS_IMPL_1(...)                                                       \
  static void ctor(                                                                                \
      __BOOST_DI_REPEAT(__BOOST_DI_SIZE(__VA_ARGS__), __BOOST_DI_GEN_CTOR, __VA_ARGS__));          \
  static void name(                                                                                \
      __BOOST_DI_REPEAT(__BOOST_DI_SIZE(__VA_ARGS__), __BOOST_DI_GEN_NAME, __VA_ARGS__));          \
