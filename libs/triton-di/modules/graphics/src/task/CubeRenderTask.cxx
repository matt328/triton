...
auto CubeRenderTask::registerResource(ResourceSlot slot,
                                      [[maybe_unused]] std::string_view resourceName) -> void {
  if (slot == ResourceSlot::DrawCountBuffer) {
    // Add a struct to the map that will tell the TaskGraph
    // a) Order, and
    // b) how to create a barrier before this task records its commands.
  }
}
