...
StaticModelPipeline::StaticModelPipeline(const std::shared_ptr<IGraphicsDevice>& graphicsDevice,
  ...
  pipelineLayout = graphicsDevice->createPipelineLayout(pipelineLayoutCreateInfo, "StaticModel");
  ...
  auto vsm =
      shaderCompiler->createShaderModule(vk::ShaderStageFlagBits::eVertex, SHADERS / "shader.vert");
