...
inline SwapchainSupportDetails querySwapchainSupport(const vk::raii::PhysicalDevice& possibleDevice,
                                                     const vk::raii::SurfaceKHR& surface) {
...
void setObjectName(T const& handle,
  ...
  auto fn = (PFN_vkDebugMarkerSetObjectNameEXT)vkGetDeviceProcAddr(*device,
