...
auto GeometryFactory::generateNormal(const int x, const int y, const ct::HeightField& heightField)
    -> glm::vec3 {
...
auto GeometryFactory::generateAABB(const glm::vec3& min, const glm::vec3& max) -> GeometryHandle {
...
[[nodiscard]] auto GeometryFactory::getGeometryData(const GeometryHandle& handle) -> GeometryData {
