...
DefaultRenderer::DefaultRenderer(const RendererConfig& config,
  ...
  pipeline = std::make_shared<StaticModelPipeline>(graphicsDevice, shaderCompiler, config);
}

void DefaultRenderer::bindPipeline(const std::unique_ptr<vk::raii::CommandBuffer>& commandBuffer) {
