...
#if defined(_MSC_VER)
#pragma warning(push)
#pragma warning(disable : 4061) // enumerator 'ENUM' in switch of enum 'enum' is not explicitly
...
#define UFBX_CONVERSION_IMPL(p_name)                                                               \
   template <typename T,                                                                           \
             typename S = typename ufbxi_type_is<T,                                                \
                                                 decltype(ufbx_converter<T>::from(                 \
...
#define UFBX_CONVERSION_LIST_IMPL(p_name)                                                          \
   template <typename T,                                                                           \
             typename S = typename ufbxi_type_is<                                                  \
                 T,                                                                                \
                 decltype(ufbx_converter<T>::from_list((p_name*)nullptr, (size_t)0))>::type>       \
   operator T() const {                                                                            \
...
#define UFBX_CALLBACK_IMPL(p_name, p_fn, p_return, p_params, p_args)                               \
   template <typename F>                                                                           \
   static p_return _cpp_adapter p_params {                                                         \
...
UFBX_ENUM_TYPE(ufbx_subdivision_display_mode,
               UFBX_SUBDIVISION_DISPLAY_MODE,
               UFBX_SUBDIVISION_DISPLAY_SMOOTH);
...
UFBX_ENUM_TYPE(ufbx_subdivision_boundary,
               UFBX_SUBDIVISION_BOUNDARY,
               UFBX_SUBDIVISION_BOUNDARY_SHARP_INTERIOR);
...
struct ufbx_mesh {
   ...
   ufbx_uint32_list
       face_material;           // < Indices to `ufbx_mesh.materials[]` and `ufbx_node.materials[]`
   ...
   ufbx_vertex_vec3 vertex_normal;    // < (optional) Normal vectors, always defined if
...
struct ufbx_skin_cluster {
   ...
   // NOTE: These may be out-of-bounds for a given mesh, `ufbx_skin_deformer.vertices` is always
   // safe.
...
UFBX_ENUM_TYPE(ufbx_cache_data_encoding,
               UFBX_CACHE_DATA_ENCODING,
...
UFBX_ENUM_TYPE(ufbx_cache_interpretation,
               UFBX_CACHE_INTERPRETATION,
               UFBX_CACHE_INTERPRETATION_VERTEX_NORMAL);
...
typedef struct ufbx_material_feature_info {
   ...
   // NOTE: The feature can be enabled but still not used if eg. the corresponding factor is at
   // zero!
   bool enabled;
...
UFBX_ENUM_TYPE(ufbx_material_pbr_map,
               UFBX_MATERIAL_PBR_MAP,
               UFBX_MATERIAL_PBR_TRANSMISSION_GLOSSINESS);
...
UFBX_ENUM_TYPE(ufbx_material_feature,
               UFBX_MATERIAL_FEATURE,
               UFBX_MATERIAL_FEATURE_TRANSMISSION_ROUGHNESS_AS_GLOSSINESS);
...
struct ufbx_texture {
   ...
   // is _not_ specified. Some known shaders that represent files are interpreted as
   // `UFBX_TEXTURE_FILE`.
...
UFBX_ENUM_TYPE(ufbx_constraint_aim_up_type,
               UFBX_CONSTRAINT_AIM_UP_TYPE,
...
UFBX_ENUM_TYPE(ufbx_constraint_ik_pole_type,
               UFBX_CONSTRAINT_IK_POLE_TYPE,
...
typedef bool ufbx_open_file_fn(void* user,
                               ufbx_stream* stream,
                               const char* path,
                               size_t path_len,
...
typedef struct ufbx_open_file_cb {
   ...
   UFBX_CALLBACK_IMPL(ufbx_open_file_cb,
                      ufbx_open_file_fn,
                      bool,
                      (void* user,
                       ufbx_stream* stream,
...
typedef struct ufbx_close_memory_cb {
   ...
   UFBX_CALLBACK_IMPL(ufbx_close_memory_cb,
...
typedef enum ufbx_error_type UFBX_ENUM_REPR {
   ...
   // `ufbx_load_opts.filename` when using `ufbx_load_memory()` to let ufbx guess the format from
   // the extension.
...
typedef struct ufbx_progress_cb {
   ...
   UFBX_CALLBACK_IMPL(ufbx_progress_cb,
                      ufbx_progress_fn,
                      ufbx_progress_result,
...
UFBX_ENUM_TYPE(ufbx_index_error_handling,
               UFBX_INDEX_ERROR_HANDLING,
               UFBX_INDEX_ERROR_HANDLING_UNSAFE_IGNORE);
...
UFBX_ENUM_TYPE(ufbx_unicode_error_handling,
               UFBX_UNICODE_ERROR_HANDLING,
               UFBX_UNICODE_ERROR_HANDLING_UNSAFE_IGNORE);
...
UFBX_ENUM_TYPE(ufbx_inherit_mode_handling,
               UFBX_INHERIT_MODE_HANDLING,
               UFBX_INHERIT_MODE_HANDLING_IGNORE);
...
typedef bool ufbx_thread_pool_init_fn(void* user,
                                      ufbx_thread_pool_context ctx,
                                      const ufbx_thread_pool_info* info);
typedef bool ufbx_thread_pool_run_fn(void* user,
                                     ufbx_thread_pool_context ctx,
                                     uint32_t group,
                                     uint32_t start_index,
                                     uint32_t count);
typedef bool ufbx_thread_pool_wait_fn(void* user,
                                      ufbx_thread_pool_context ctx,
                                      uint32_t group,
                                      uint32_t max_index);
...
ufbx_abi ufbx_scene* ufbx_load_memory(const void* data,
                                      size_t data_size,
...
// NOTE: `file` is passed as a `void` pointer to avoid including <stdio.h>
ufbx_abi ufbx_scene* ufbx_load_stdio_prefix(void* file,
                                            const void* prefix,
                                            size_t prefix_size,
                                            const ufbx_load_opts* opts,
                                            ufbx_error* error);
...
ufbx_abi ufbx_real ufbx_find_real_len(const ufbx_props* props,
                                      const char* name,
                                      size_t name_len,
                                      ufbx_real def);
...
ufbx_abi ufbx_vec3 ufbx_find_vec3_len(const ufbx_props* props,
                                      const char* name,
                                      size_t name_len,
                                      ufbx_vec3 def);
...
ufbx_abi int64_t ufbx_find_int_len(const ufbx_props* props,
                                   const char* name,
                                   size_t name_len,
                                   int64_t def);
...
ufbx_abi bool ufbx_find_bool_len(const ufbx_props* props,
                                 const char* name,
                                 size_t name_len,
                                 bool def);
...
ufbx_abi ufbx_blob ufbx_find_blob_len(const ufbx_props* props,
                                      const char* name,
                                      size_t name_len,
                                      ufbx_blob def);
...
ufbx_abi ptrdiff_t ufbx_inflate(void* dst,
                                size_t dst_size,
...
ufbx_abi bool ufbx_default_open_file(void* user,
                                     ufbx_stream* stream,
                                     const char* path,
                                     size_t path_len,
                                     const ufbx_open_file_info* info);
...
ufbx_abi bool ufbx_open_memory(ufbx_stream* stream,
                               const void* data,
                               size_t data_size,
...
// NOTE: Return value uses `1.0` for full weight, instead of `100.0` that the internal property
// `UFBX_Weight` uses.
...
ufbx_abi ufbx_baked_node* ufbx_find_baked_node_by_typed_id(ufbx_baked_anim* bake,
                                                           uint32_t typed_id);
ufbx_abi ufbx_baked_node* ufbx_find_baked_node(ufbx_baked_anim* bake, ufbx_node* node);

ufbx_abi ufbx_baked_element* ufbx_find_baked_element_by_element_id(ufbx_baked_anim* bake,
                                                                   uint32_t element_id);
...
ufbx_abi ufbx_shader_texture_input* ufbx_find_shader_texture_input_len(
    const ufbx_shader_texture* shader,
    const char* name,
    size_t name_len);
...
ufbx_inline ufbx_matrix ufbx_get_skin_vertex_matrix(const ufbx_skin_deformer* skin,
                                                    size_t vertex,
                                                    const ufbx_matrix* fallback) {
...
ufbx_abi ufbx_surface_point ufbx_evaluate_nurbs_surface(const ufbx_nurbs_surface* surface,
                                                        ufbx_real u,
                                                        ufbx_real v);
...
ufbx_abi ufbx_vec3 ufbx_catch_get_weighted_face_normal(ufbx_panic* panic,
                                                       const ufbx_vertex_vec3* positions,
                                                       ufbx_face face);
ufbx_inline ufbx_vec3 ufbx_get_weighted_face_normal(const ufbx_vertex_vec3* positions,
                                                    ufbx_face face) {
...
ufbx_abi ufbx_mesh* ufbx_subdivide_mesh(const ufbx_mesh* mesh,
                                        size_t level,
...
ufbx_abi size_t ufbx_sample_geometry_cache_real(const ufbx_cache_channel* channel,
                                                double time,
                                                ufbx_real* data,
                                                size_t num_data,
                                                const ufbx_geometry_cache_data_opts* opts);
ufbx_abi size_t ufbx_sample_geometry_cache_vec3(const ufbx_cache_channel* channel,
                                                double time,
                                                ufbx_vec3* data,
                                                size_t num_data,
                                                const ufbx_geometry_cache_data_opts* opts);
...
// `streams` specifies one or more vertex data arrays, each stream must contain `num_indices`
// vertices. This function compacts the data within `streams` in-place, writing the deduplicated
// indices to `indices`.
...
ufbx_unsafe ufbx_abi void ufbx_thread_pool_set_user_ptr(ufbx_thread_pool_context ctx,
                                                        void* user_ptr);
...
template <>
struct ufbx_type_traits<ufbx_scene> {
   enum {
      valid = 1
   };
...
template <>
struct ufbx_type_traits<ufbx_mesh> {
   enum {
      valid = 1
   };
...
template <>
struct ufbx_type_traits<ufbx_line_curve> {
   enum {
      valid = 1
   };
...
template <>
struct ufbx_type_traits<ufbx_geometry_cache> {
   enum {
      valid = 1
   };
...
template <>
struct ufbx_type_traits<ufbx_anim> {
   enum {
      valid = 1
   };
...
template <>
struct ufbx_type_traits<ufbx_baked_anim> {
   enum {
      valid = 1
   };
