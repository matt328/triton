...
RendererBase::RendererBase(const RendererBaseCreateInfo& createInfo) :
    device(createInfo.device), allocator(createInfo.allocator),
    depthTexture(createInfo.depthTexture), framebufferSize(createInfo.swapchainExtent),
    framesInFlight(createInfo.swapchainImages.size()), swapchainImages(createInfo.swapchainImages) {
